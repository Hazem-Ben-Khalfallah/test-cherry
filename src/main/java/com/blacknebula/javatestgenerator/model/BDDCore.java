...
public final class BDDCore {
    ...
    /**
     * It will create a test class and it will use the test framework configured for this project, if the project doesn't have a TestFramework selected it will throw an exception of type {@link com.blacknebula.javatestgenerator.TestFrameworkNotConfigured}
     * <br />
