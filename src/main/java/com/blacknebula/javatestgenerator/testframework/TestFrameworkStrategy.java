package com.blacknebula.javatestgenerator.testframework;
...
public interface TestFrameworkStrategy {
    ...
    /**
     * This strategy will generate a PsiMethod that will back up the {@link com.blacknebula.javatestgenerator.model.TestMethod}
     *
     * @param testClass
     * @param sutMethod
